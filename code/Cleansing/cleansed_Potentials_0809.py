...
# 전처리본
contacts_fill = pd.read_csv('../../resource/CleansedData/Contacts_001_fillTerritories_ver2.csv')
accounts_fill = pd.read_csv('../../resource/CleansedData/Accounts_001_fillTerritories_final.csv')
