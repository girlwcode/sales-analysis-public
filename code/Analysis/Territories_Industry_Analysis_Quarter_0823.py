...
for industry in industries:
    ...
    for year in years:
        for i, month in enumerate(months):
            ...
            df_industry2 = deal_ids2[(deal_ids2['year'] == year) & (deal_ids2['month'].isin(month))]
            ...
            df_industry3 = deal_ids3[(deal_ids3['year'] == year) & (deal_ids3['month'].isin(month))]
...
for industry in industries:
    ...
    for year in years:
        for i, month in enumerate(months):
            ...
            df_lead2 = lead_ids2[(lead_ids2['year'] == year) & (lead_ids2['month'].isin(month))]
            df_deal2 = deal_ids2[(deal_ids2['year'] == year) & (deal_ids2['month'].isin(month))]
            ...
            df_lead3 = lead_ids3[(lead_ids3['year'] == year) & (lead_ids3['month'].isin(month))]
            df_deal3 = deal_ids3[(deal_ids3['year'] == year) & (deal_ids3['month'].isin(month))]
